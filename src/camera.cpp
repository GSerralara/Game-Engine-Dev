...
void Camera::updateFollow() {
	this->center = Vector3(this->tofollow->model.m[12], this->tofollow->model.m[13], this->tofollow->model.m[14]) + (this->tofollow->model.frontVector().normalize() * -10);
	this->eye = Vector3(this->tofollow->model.m[12], this->tofollow->model.m[13], this->tofollow->model.m[14]) + (this->tofollow->model.frontVector().normalize() * 30) + ((Vector3(this->tofollow->model.m[4], this->tofollow->model.m[5], this->tofollow->model.m[6])).normalize() * 15);
	this->up = Vector3(this->tofollow->model.m[4], this->tofollow->model.m[5], this->tofollow->model.m[6]);
